...
import de.escalon.hypermedia.sample.springboot.beans.event.Rating;
import de.escalon.hypermedia.sample.springboot.beans.event.Review;
import de.escalon.hypermedia.sample.springboot.model.event.CreativeWork;
import de.escalon.hypermedia.sample.springboot.model.event.EventModel;
import de.escalon.hypermedia.sample.springboot.model.event.EventStatusType;
